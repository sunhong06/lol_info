...
const summonerData = createSlice({
  ...
  reducers:{
    ...
    ResetComponent:(state:any,action)=>{
...
export const { CountingNum,RankSearch,MatchInfo,MatchData,RankDatas,ChampionData,ChampionsRemove,summoner,LeagueData,CommunitySearched } = summonerData.actions;
